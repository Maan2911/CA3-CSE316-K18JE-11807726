...
class Chess:
    def _init_(self):
        ...
        self.gameboard = {}
        self.placePieces()
        print("chess program. enter moves in this type of notation ex:e7 e6")
        self.main()

#this is  for defining places of pieces
...
# for king ,check all black piece if it hits the king or is it checkmate
...
#checks if any pieces in piece list (which is an array of (piece,position) tuples) can see the king in kingpos
 ...
 #input method for game in algebraic notation
  ...
  # printing of chess board in without gui
...
class Piece:
 ...
 #"checks if position is on the board or available "
...
#moves of all pieces defined  by each class and method of its name
...
#this is to show all available moves for the selected pieces
...
#used dicitionary for printing the pic of all black and white pieces 
